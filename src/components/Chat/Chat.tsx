  ...
  return (
    <>
      <div className="ask-area">
        ...
        <input type="radio" name="mode" id="mode-research" className="model-radio" />
        <input type="radio" name="mode" id="mode-finance" className="model-radio" />
          ...
          <div className="ask-controls">
            <div className="ask-left">
              <button className="round-btn" title="Attach files">
                <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"><line x1="12" y1="5" x2="12" y2="19" /><line x1="5" y1="12" x2="19" y2="12" /></svg>
              </button>
              ...
              <div className="model-dd">
                ...
                <label htmlFor="mode-toggle" className="model-btn mode-btn">
                  ...
                  <span className="mode-ico i-finance">
                    <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><polyline points="22 7 13.5 15.5 8.5 10.5 2 17" /><polyline points="16 7 22 7 22 13" /></svg>
                  </span>
                  <span className="mode-current"></span>
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="6 9 12 15 18 9" /></svg>
                </label>
                <label htmlFor="mode-toggle" className="dd-overlay"></label>
                <div className="dd-menu drop-down left">
                  ...
                  <label htmlFor="mode-search" className="dd-item">
                    <span className="dd-left">
                      ...
                      <span className="dd-text">Search<small>Fast answers from the web</small></span>
                    </span>
                  </label>
                  <label htmlFor="mode-research" className="dd-item">
                    <span className="dd-left">
                      ...
                      <span className="dd-text">Research<small>Deep multi-step analysis</small></span>
                    </span>
                  </label>
                  <label htmlFor="mode-finance" className="dd-item">
                    <span className="dd-left">
                      ...
                      <span className="dd-text">Finance<small>Live market data &amp; filings</small></span>
                    </span>
                  </label>
                </div>
              </div>
